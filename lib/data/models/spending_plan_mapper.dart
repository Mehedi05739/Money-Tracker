...
class SpendingPlanMapper {
  ...
  static Map<String, Object?> toRow(SpendingPlan plan,
...
class SpendingPlanItemMapper {
  ...
  static SpendingPlanItem fromRow(Map<String, Object?> row) =>
      SpendingPlanItem(
  ...
  static Map<String, Object?> toRow(SpendingPlanItem item,
      {bool includeId = false}) {
    return {
